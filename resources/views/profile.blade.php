                            ...
                            <div class="widget-content widget-content-area">
                                <div class="custom-file-container" data-upload-id="myFirstImage1">
                                    ...
                                    <label class="custom-file-container__custom-file" >
                                        <input type="file" class="custom-file-container__custom-file__custom-file-input" onchange="ValidateExtensionone(this.value);" accept="image/*,application/pdf" id="fileone" name="fileone"  value="">
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="custom-file-container" data-upload-id="myFirstImage2">
                                    ...
                                    <label class="custom-file-container__custom-file" >
                                        <input type="file" class="custom-file-container__custom-file__custom-file-input" onchange="ValidateExtensiontwo(this.value);" accept="image/*,application/pdf" id="filetwo" name="filetwo" value="">
...
<div class="row">
    <div class="col-md-12" id="rut_natural">
        <label for="rut_nat"><span style="color: red !important;">*</span> <b>{{ __('auth.rut') }}</b></label>
        <input type="text" id="rut_nat" name="rut_nat" onblur="isValidRUT(this.value)" class="form-control">
    </div>
    <div class="col-md-12" id="rut_juridica" hidden="true">
        <label for="rut"><span style="color: red !important;">*</span> <b>{{ __('auth.rutJur') }}</b></label>
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="custom-file-container" data-upload-id="myFirstImage3">
                                    <label>Anverso <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">X</a></label>
                                    <label class="custom-file-container__custom-file" >
                                        <input type="file" class="custom-file-container__custom-file__custom-file-input" onchange="ValidateExtensionthree(this.value);" accept="image/*,application/pdf" id="filetrhee" name="filetrhee" value="">
        ...
        <div class="alert alert-dismissible fade show" role="alert" style="color: #fff; background-color: #A2DADA !important;border-color: #A2DADA !important;">
            <strong>
                <div class="custom-control custom-checkbox mr-3">
                    ...
                    <br>
                    <a href="https://storage.googleapis.com/vivenikken/pdf/others/Chile/Politica-de-privacidad.pdf"  target="_blank">
...
<script type="text/javascript">
  ...
  if (file != '') {
    if(ext == "pdf" || ext == "png" || ext == "jpg" || ext == "jpeg" || ext == "heic" || ext == "PNG" || ext == "JPG" || ext == "JPEG" || ext == "HEIC" || ext == "PDF"){
